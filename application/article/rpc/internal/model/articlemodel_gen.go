...
var (
	...
	cacheWgZhihuArticleIdPrefix = "cache:wgZhihuArticle:article:id:"
)
...
func (m *defaultArticleModel) FindOne(ctx context.Context, id int64) (*Article, error) {
	beyondArticleArticleIdKey := fmt.Sprintf("%s%v", cacheWgZhihuArticleIdPrefix, id)
	var resp Article
...
func (m *defaultArticleModel) Insert(ctx context.Context, data *Article) (sql.Result, error) {
	beyondArticleArticleIdKey := fmt.Sprintf("%s%v", cacheWgZhihuArticleIdPrefix, data.Id)
...
func (m *defaultArticleModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheWgZhihuArticleIdPrefix, primary)
}
